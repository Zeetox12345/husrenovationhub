...
const Tagrenovering = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Nyt tag i 2025 - Den komplette guide til tagrenovering</title>
        <meta name="description" content="Få indsigt i priser, materialer og lovkrav ved tagrenovering. Komplet guide til tagtyper, vedligeholdelse og valg af professionelle tageksperter." />
      ...
      <div className="relative w-full h-[300px] md:h-[500px] mb-4 md:mb-6">
        {/* Hero image */}
        ...
        <div className="relative z-10 h-full flex flex-col justify-center items-center px-4 text-center">
          <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold text-white leading-tight mb-2 md:mb-4 max-w-4xl">
            Hvad koster et nyt tag? Komplet guide til tagrenovering for alle tagtyper i 2025
          </h1>
        </div>
      </div>
                ...
                <div className="mb-4">
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      ...
                      <span className="text-sm">3 gratis tilbud fra forskellige tagfirmaer</span>
                    </li>
                    <li className="flex items-start">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-green-500 mr-2 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              ...
              <div className="md:w-1/2 relative">
                <a href={affiliateLink} target="_blank" rel="noopener noreferrer" className="block h-full">
                  <img 
                    ...
                    alt="Tagrenovering med 3byggetilbud.dk" 
                    className="w-full h-full object-cover"
                  />
                </a>
              </div>
      ...
      <div className="container">
        <div className="max-w-3xl mx-auto">
          ...
          <div id="intro" className="text-xl text-gray-700 mb-8 animate-fade-in space-y-4" style={{ animationDelay: "0.2s" }}>
            <p>
              En tagrenovering er ofte et af de mest omfattende projekter, du kan kaste dig ud i som boligejer.
            </p>
            <p>
              Ikke alene kan prisen let overstige 100.000 kroner, men processen indebærer også en række valg om både materialer, isoleringsmuligheder og æstetik.
            </p>
            <p>
              Alligevel kan tagrenoveringen hurtigt vise sig at være en fornuftig investering, da den både reducerer varmeregningen og øger boligens samlede værdi.
            </p>
          </div>
          
          {/* Original partner section removed from here */}
        </div>
      </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="mb-8">
              ...
              <div id="kvadratmeterpris" className="space-y-6 text-gray-700">
                <h3 className="text-xl md:text-2xl font-semibold text-gray-900 mb-4">
                  Nyt tag: Hvad koster det pr. kvadratmeter?
                </h3>
                
                <p>
                  Erfaringer fra tidligere projekter viser, at et nyt tag typisk koster mellem 700 og 2.300 kr. pr. m². Prisen varierer dog baseret på flere vigtige faktorer, blandt andet:
                </p>
                
                <ul className="list-disc pl-6 space-y-2">
                  <li>Valg af tagbelægning (f.eks. tegl, beton eller tagpap)</li>
                ...
                <p>
                  Nedenfor finder du et overblik over erfaringsmæssige kvadratmeterpriser, så du kan få en fornemmelse af det samlede budget for dit nye tag.
                </p>
                  ...
                  <table className="min-w-full border-collapse bg-white shadow-md rounded-lg overflow-hidden">
                    <thead className="bg-gray-700 text-white">
                      <tr>
                        ...
                        <th className="py-3 px-4 text-left">Kvadratmeterpris</th>
                ...
                <div className="my-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="rounded-lg overflow-hidden shadow-md">
                    <img 
                      ...
                      alt="Eksempel på tagkonstruktion" 
                      className="w-full h-64 object-cover" 
                    />
                    <div className="bg-gray-50 p-3">
                      <p className="text-sm text-gray-700 font-medium">Professionel tagrenovering kan øge boligens værdi betydeligt</p>
                    </div>
                  </div>
                  <div className="rounded-lg overflow-hidden shadow-md">
                    <img 
                      src="/lovable-uploads/roof2.jpg" 
                      alt="Tagbelægningstyper" 
                      className="w-full h-64 object-cover" 
                    />
                    <div className="bg-gray-50 p-3">
                      <p className="text-sm text-gray-700 font-medium">Valg af den rette tagtype er afgørende for langtidsholdbarhed</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div id="prisafgoer" className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">
                Hvad afgør prisen på en tagrenovering?
              </h2>
              
              <div className="space-y-6 text-gray-700">
                <p>
                  Prisen for at renovere eller udskifte taget kan variere betydeligt, og selv de bedste prisoverslag vil indeholde en vis usikkerhed. Her er nogle af de vigtigste faktorer, der typisk påvirker den samlede pris:
                </p>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-6 space-y-1 mt-2">
                      ...
                      <li>Timelønnen varierer fra landsdel til landsdel, hvilket påvirker den endelige regning.</li>
                    </ul>
                  </div>
                ...
                <p>
                  Uanset hvordan dit projekt ser ud, bør du være opmærksom på alle ovenstående faktorer, når du indhenter tilbud. Det giver dig et mere nøjagtigt billede af de samlede omkostninger og hjælper med at undgå ubehagelige overraskelser.
                </p>
              </div>
            </div>
            ...
            <div id="vaelg-tag" className="mb-12">
              ...
              <div className="space-y-6 text-gray-700">
                <p>
                  Når du planlægger en tagudskiftning eller tagrenovering, er det afgørende at vælge en tagbelægning, som din tagkonstruktion kan bære. Du kan enten vælge samme type tagbelægning som den eksisterende eller benytte følgende generelle tommelfingerregel baseret på vægt.
                </p>
                ...
                <div className="bg-gray-50 p-5 rounded-lg border-l-4 border-brand-blue">
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    ...
                    <li>Undersøg forskellige lette tagtyper (fx fibercement, tagpap eller lette ståltage) for at finde den bedste løsning til dit projekt.</li>
                  </ul>
                </div>
                
                <p>
                  Ved at følge disse retningslinjer undgår du unødige skader på din tagkonstruktion og sikrer samtidig, at din nye tagbelægning holder i mange år frem. Det er altid en god idé at rådføre sig med en professionel, hvis du er i tvivl om, hvorvidt dit tag kan klare en specifik belægningstype.
                </p>
            ...
            <div id="tjekstand" className="mb-12">
              ...
              <div className="space-y-6 text-gray-700">
                <p>
                  Hyppigheden af et grundigt tagtjek afhænger i høj grad af tagets alder. Er taget under 15 år gammelt, kan du ofte nøjes med at få det kontrolleret hvert 5.–10. år. Har du derimod et ældre tag, anbefales det at få foretaget et tageftersyn mindst én gang årligt – og helst to gange om året.
                </p>
                
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-xl font-semibold text-gray-900 mb-4">Vigtige tjekpunkter</h3>
                  <ul className="list-disc pl-6 space-y-2">
                    <li>Rensning af tagrender: Du kan selv nemt tømme og rense tagrender for at undgå tilstoppede afløb.</li>
                    <li>Visuel kontrol: Hold øje med løse tagsten, revner eller skader på overfladen.</li>
                    <li>Professionel vurdering: Ønsker du en komplet gennemgang, er det klogt at kontakte et professionelt tagfirma.</li>
                  </ul>
                </div>
            ...
            <div id="utaetheder" className="mb-12">
              ...
              <div className="space-y-6 text-gray-700">
                <p>
                  Selvom ethvert tag er unikt, er der visse områder, hvor der oftere opstår skader og utætheder end andre. Her er fem typiske kilder til vandindtrængning:
                </p>
                ...
                <div className="my-6 rounded-lg overflow-hidden shadow-lg">
                  <img 
                    src="/lovable-uploads/roof2.jpg" 
                    alt="Inspektion af tag for utætheder" 
                    className="w-full h-auto object-cover"
                  />
                  <div className="bg-gray-50 p-3">
                    <p className="text-sm text-gray-700 italic">Regelmæssig inspektion af taget kan forhindre dyre skader forårsaget af utætheder</p>
                  </div>
                </div>
                ...
                <p>
                  Når en professionel taglægger tjekker for utætheder, vil vedkommende inspicere alle disse udsatte områder samt resten af tagfladen for revner eller huller. Et grundigt eftersyn kan forebygge alvorlige skader og fordyrede reparationer på længere sigt.
                </p>
              </div>
            </div>
            ...
            <div id="isolering" className="mb-12">
              ...
              <div className="space-y-6 text-gray-700">
                ...
                <div className="my-6 rounded-lg overflow-hidden shadow-lg">
                  ...
                  />
                  <div className="bg-gray-50 p-3">
                    <p className="text-sm text-gray-700 italic">Korrekt tagisolering reducerer varmeudgifter og sikrer et bedre indeklima året rundt</p>
                  </div>
                </div>
                
                <h3 className="text-xl font-semibold text-gray-900 mb-4">
                  Hvorfor er isolering af taget så afgørende?
                </h3>
                
                <ul className="list-disc pl-6 space-y-3">
                  <li className="font-medium">Bedre indeklima: Ved at holde bedre på varmen reducerer du kuldebroer og fugtproblemer.</li>
                  <li className="font-medium">Lavere varmeregning: En optimeret isolering mindsker energiforbruget markant.</li>
      ...
      <section id="loveregler" className="py-16 bg-white">
        <div className="container">
          <div className="max-w-3xl mx-auto">
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">
                Love og regler ved tagrenovering: Hvad skal du være opmærksom på?
              </h2>
              
              <div className="space-y-6 text-gray-700">
                <p>
                  Når du skal renovere eller udskifte taget, er det vigtigt at kende til de gældende love og regler, så du undgår unødvendige fejl og ekstraomkostninger. Her er tre vigtige områder, du bør undersøge, inden du går i gang: Bygningsreglementet, lokalplaner og servitutter.
                </p>
                
                <div className="bg-gray-50 p-6 rounded-lg mb-6">
                  <h3 className="text-xl font-semibold text-gray-900 mb-4">1. Bygningsreglementet</h3>
                  <p className="mb-3">
                    Bygningsreglementet er den lovgivning, der stiller krav til alt byggeri i Danmark – også tagrenoveringer. Her er nogle af de vigtigste punkter:
                  </p>
                  ...
                  <div className="space-y-4 ml-4">
                    ...
                    <div>
                      ...
                      <ul className="list-disc pl-6 space-y-1 mt-1">
                        <li>Taget skal kunne modstå det danske klima og være sikret mod vindskader, regn og fugt.</li>
                  ...
                  <div className="mt-4 p-3 bg-brand-lightBlue rounded-lg">
                    <p className="italic">
                      Tip: Selvom du kan finde mange informationer i Bygningsreglementet, kan du med fordel også rådføre dig med et professionelt tagfirma eller en uvildig byggetekniker for at sikre, at du overholder alle bestemmelser.
                    </p>
                  </div>
                </div>
                
                <div className="bg-gray-50 p-6 rounded-lg mb-6">
                  <h3 className="text-xl font-semibold text-gray-900 mb-4">2. Lokalplan</h3>
                  <p className="mb-3">
                    En lokalplan kan sætte yderligere rammer for, hvordan et tag i et bestemt område må se ud. Det kan f.eks. handle om farve, hældning eller valg af materiale.
                  </p>
                  
                  <div className="ml-4">
                    <h4 className="text-lg font-semibold text-gray-800">Sådan finder du ud af, om din ejendom er omfattet af en lokalplan:</h4>
                    <ol className="list-decimal pl-6 space-y-1 mt-2">
                      ...
                      <li>Vælg din kommune i øverste højre hjørne under "Kortudsnit" – eller indtast ejendommens adresse i feltet "Søg_adresse"</li>
                  ...
                  <div className="mt-4 p-3 bg-gray-100 rounded-lg">
                    <p className="italic">
                      Eksempel: I visse områder er kun stråtag tilladt, mens andre lokalplaner kræver, at terrasseoverdækninger laves i tagpap, metalplader eller glas.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 p-6 rounded-lg mb-6">
                  ...
                  <p className="mb-3">
                    En servitut er en tinglyst bestemmelse, der kan være knyttet til ejendommens matrikel. De er ikke så almindelige, når det gælder tage, men kan findes på fredede eller bevaringsværdige bygninger.
                  </p>
                  
                  <div className="ml-4">
                    <h4 className="text-lg font-semibold text-gray-800">Tjek for servitutter på din ejendom:</h4>
                    <ol className="list-decimal pl-6 space-y-1 mt-2">
                ...
                <div className="bg-gray-100 p-6 rounded-lg">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>Lokalplaner kan stille krav til valg af tagtype, farve eller stil.</li>
                    <li>Servitutter kan sætte yderligere begrænsninger, især på fredede eller bevaringsværdige ejendomme.</li>
                  </ul>
                  <p className="mt-4">
                    Ved at sætte dig ind i disse tre nøgleområder, undgår du dyre fejl og får en mere gnidningsfri tagrenovering. Samtidig sikrer du, at dit nye tag lever op til lovens krav og passer til både lokalområdet og eventuelle særlige servitutter.
                  </p>
                </div>
              </div>
            </div>
