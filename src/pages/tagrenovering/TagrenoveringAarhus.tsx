...
const TagrenoveringAarhus = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Nyt tag Aarhus 2025 - Den komplette guide til tagrenovering</title>
      ...
      <div className="container">
        <div className="max-w-3xl mx-auto">
          ...
          <div id="intro" className="text-xl text-gray-700 mb-8 animate-fade-in space-y-4" style={{ animationDelay: "0.2s" }}>
            ...
            <p>
              Ikke alene kan prisen let overstige 100.000 kroner i {city}-området, men processen indebærer også en række valg om både materialer, isoleringsmuligheder og æstetik, der passer til den aarhusianske byggestil.
            </p>
            <p>
              Alligevel kan tagrenoveringen hurtigt vise sig at være en fornuftig investering for {city}-boligejere, da den både reducerer varmeregningen og øger boligens samlede værdi på det østjyske boligmarked.
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="mb-8">
              ...
              <div className="space-y-6 text-gray-700">
                <p>
                  I {city} ligger prisen for et nyt tag typisk mellem 700 og 2.300 kr. pr. m², afhængigt af tagtype og kompleksitet. Lokale forhold i Østjylland kan påvirke prisen, da transportomkostninger, lokale byggetilladelser og arbejdslønnen kan variere.
                </p>
                
                <p>
                  På grund af {city}s specifikke vejrforhold med udfordringer fra Kattegatvinden og byens mikroklimaer vælger mange boligejere her at investere i holdbare tagløsninger, der er tilpasset de lokale forhold.
                </p>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="bg-white rounded-xl p-6 card-hover shadow-sm">
                ...
                <p className="text-gray-700">
                  Tegltage er meget udbredte i {city}, især på ældre ejendomme i Frederiksbjerg og midtbyen. De er holdbare, æstetisk tiltalende og passer godt til den aarhusianske arkitektur. Med en levetid på 60-100 år er de en solid investering.
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 card-hover shadow-sm">
                ...
                <p className="text-gray-700">
                  Mange boliger i {city}s forstadsområder som Viby og Åbyhøj har eternittag, som er lette og vedligeholdelsesvenlige. Moderne eternitplader er fri for asbest og passer godt til områdets nyere byggerier.
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 card-hover shadow-sm">
                ...
                <p className="text-gray-700">
                  I {city} bruges tagpap ofte på flade tage og på nybyggerier i havneområdet. Det er en økonomisk løsning, der fungerer godt i byens klimaforhold, og som let kan vedligeholdes og repareres ved behov.
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 card-hover shadow-sm">
                ...
                <p className="text-gray-700">
                  Med byens fokus på bæredygtighed er grønne tage blevet populære i {city}, særligt i nye boligområder som Lisbjerg og Aarhus Ø. De tilbyder god isolering, regnvandsabsorbering og bidrager til byens grønne profil.
                </p>
              </div>
            </div>
            ...
            <div className="bg-brand-lightBlue rounded-xl p-8 text-center mb-12 shadow-md">
              ...
              <p className="text-gray-700 mb-6">
                Vores erfarne tageksperter i {city} kan hjælpe dig med at vurdere tagets tilstand og anbefale den rette løsning for dit hjem, uanset om du bor i Risskov, Højbjerg eller midtbyen.
              </p>
            ...
            <div className="mb-12">
              ...
              <div className="space-y-6 text-gray-700">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>Aarhus Kommune har specifikke krav til byggetilladelser, især for ejendomme i de fredede områder af midtbyen</li>
                  <li>Byens varierende topografi med både bakker og kystlinje påvirker tagkonstruktionernes udsættelse for vind og vejr</li>
                  <li>I områder som Frederiksbjerg og Trøjborg er der strenge regler for ændringer i tagenes udseende på grund af bevaringsværdige bygninger</li>
                  <li>Flere områder i Aarhus, særligt i midtbyen, kan have begrænsninger for byggehøjde og tagmaterialer</li>
                  <li>Aarhus' bæredygtighedsprofil betyder, at energieffektiv isolering og evt. solceller på taget er attraktive tilvalg</li>
                </ul>
                <p>
      ...
      <section id="haandvaerkere" className="py-16 bg-gray-50">
        <div className="container">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6 text-gray-700">
              <p>
                At finde kvalificerede håndværkere i {city} kan være en udfordring, især i perioder med høj byggeaktivitet i byens ekspanderende områder som Lisbjerg og Nye. Her er nogle fordele ved at bruge vores service:
              </p>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <div className="bg-white rounded-xl p-8 border border-brand-blue shadow-md mt-8">
              ...
              <div className="space-y-4 text-gray-700">
                ...
                <p>
                  Hos <a href={affiliateLink} target="_blank" rel="noopener noreferrer" className="text-brand-blue hover:underline font-semibold">3byggetilbud.dk</a> kan private boligejere, erhvervsdrivende og boligforeninger i {city} indhente 3 tilbud på enhver tagrenovering - fra små projekter i Hasle til omfattende renoveringer i Risskov. 
                </p>
              </div>
