...
const TagrenoveringAarhus = () => {
  const affiliateLink = "https://example.com/affiliate/tag/aarhus";
  ...
  return (
    <>
      <Helmet>
        <title>Tagrenovering i Aarhus – Få 3 gratis tilbud på nyt tag</title>
        <meta name="description" content="Få 3 gratis tilbud på tagrenovering fra professionelle håndværkere i Aarhus. Sammenlign priser og kvalitet uden forpligtelser." />
        <meta name="keywords" content="tagrenovering aarhus, tag aarhus, tagarbejde aarhus, tagudskiftning aarhus, tagreparation aarhus" />
        <link rel="canonical" href="https://husrenovation.dk/tagrenovering-aarhus" />
      </Helmet>
