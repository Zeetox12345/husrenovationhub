    ...
    <>
      ...
      <div className="container">
        <div className="max-w-3xl mx-auto">
          ...
          {/* Remove the original partner section from here */}
        </div>
      </div>
...
export default TagrenoveringHelsingor; 
