        ...
        <Container>
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-700 mb-8 animate-fade-in" style={{ animationDelay: "0.2s" }}>
              ...
              Spar tid og penge ved at modtage 3 gratis og uforpligtende tilbud fra professionelle firma i Randers.
            </p>
            ...
            {/* Partner Section */}
            <PartnerSection city="Randers" affiliateLink={affiliateLink} />
